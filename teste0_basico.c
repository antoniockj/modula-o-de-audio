...
#define INPUT_FILE "Trab2/data/sonic1.wav" /* Ajuste o caminho para apontar para o arquivo correto! */
#define OUTPUT_FILE "Trab2/data/teste0_basico.wav" /* Ajuste o caminho para apontar para o arquivo correto! */
